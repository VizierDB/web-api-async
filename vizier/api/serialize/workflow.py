...
def WORKFLOW_UPDATE_RESULT(project, branch, workflow, modified_modules, urls):
    """Dictionary serialization for the result of a workflow update operation
    (i.e., append, cancel, delete, insert, or replace).
    ...
    workflow: vizier.viztrail.workflow.WorkflowHandle
        Workflow handle
    modified_modules: list(vizier.viztrail.module.base.ModuleHandle)
        List of modules that were affected by the operation
    urls: vizier.api.routes.base.UrlFactory
        Factory for resource urls
