...
from vizier.datastore.mimir.factory import MimirDatastoreFactory, PARA_DIRECTORY
...
class TestMimirDatastoreFactory(unittest.TestCase):
    ...
    def test_create_and_delete_datastore(self):
        ...
        fact = MimirDatastoreFactory(properties={PARA_DIRECTORY: SERVER_DIR})
