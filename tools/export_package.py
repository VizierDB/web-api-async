...
from vizier.packages.mimir.base import export_package as export_mimir
from vizier.packages.plot.base import export_package as export_plot
from vizier.packages.pycell.base import export_package as export_python
from vizier.packages.vizual.base import export_package as export_vizual
...
if __name__ == '__main__':
    ...
    if len(args) < 1 or len(args) > 3:
        print """Usage:
  <package-name> [ MIMIR | PLOT | PYTHON | VIZUAL ]
  <file-name>
  {<format> [YAML | JSON]}"""
        sys.exit(-1)
    name = args[0]
